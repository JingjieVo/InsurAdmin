...
export default function SignIn() {
  ...
  const [role, setRole] = useState(1); // Default to Administrator (1)
  ...
  useEffect(() => {
    if (isLoggedIn) {
      navigate('/'); // Nếu đã đăng nhập, điều hướng tới trang chủ
    }
  });
      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value={3}>Nhà bảo hiểm</option>
                </select>
              </div>
            ...
            <Modal3
              initModal={isModalOpen}
              onClose={() => setIsModalOpen(false)}
              messageTitle="Đ ăng nhập thất bại"
              message="Vui lòng chọn đúng vai trò và đúng thông tin "
            />
          </div>
        </div>
      </div>
