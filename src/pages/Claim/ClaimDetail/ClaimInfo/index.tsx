    ...
    <Container>
      <ContentWrapper>
        ...
        <div className="space-y-2">
          <div>
            <strong>Ngày gửi:</strong> <span className="border p-1">{claimFileData.submissionDate}</span>
          </div>
          <div>
            <strong>Ngày cập nhật:</strong> <span className="border p-1">{claimFileData.updateDate}</span>
          </div>
          <div>
          ...
          <div>
            <strong>Ngày khám/nhận viên:</strong> <span className="border p-1">{claimFileData.examDate}</span>
          </div>
        </div>
      </ContentWrapper>
    </Container>
